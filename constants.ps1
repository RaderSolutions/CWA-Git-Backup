## js constants variable copied from this repo: https://github.com/k-grube/labtech-script-decode/blob/master/lib/constants.js
## Then run through this online formatter: https://www.freeformatter.com/json-formatter.html

$scriptFunctionConstantsPSObject = @"
{
   "OsLimits": {
